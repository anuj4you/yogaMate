...
export default function AboutUs() {
  return (
    <div className=" h-[95vh] flex flex-col justify-center justify-items-center text-center">
      <h4 className="font-bold text-3xl py-1 px-4 text-[#C47A5E]">About Us </h4> <hr />
      ...
      <div className=" grid grid-cols-2 gap-4 justify-items-center px-4 py-4">
        <div className=" h-56 flex flex-col items-center justify-center text-center bg-[#C47A5E] px-3 py-2 mx-3 my-3 w-7/12 ">
        ...
        <div className=" h-56 flex flex-col items-center justify-center text-center bg-[#513125] px-3 py-2 mx-3 my-3 w-7/12 ">
        ...
        <div className=" h-56 flex flex-col items-center justify-center text-center bg-[#FFEFD1] px-3 py-2 mx-3 my-3 w-7/12 ">
