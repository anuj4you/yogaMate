...
export default function Hero() {
  ...
  return (
    ...
    <button type="button" className=" w-4/12 text-[#513125] bg-transparent hover:bg-[#C47A5E]   font-medium  text-base px-5 py-1.5 mr-2 mb-2  border-2 border-[#513125] focus:ring-4 focus:ring-yellow-300">Contact Us</button></div>
