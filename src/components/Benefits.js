...
export default function Benefits() {
  ...
  return (
    <div className=" bg-orange-50 h-[75vh] px-5 py-5 flex flex-col justify-center  ">
      <h3 className=" text-[#513125] text-4xl flex justify-center font-bold cormorant py-3 my-2">
        Benefits of yoga
      </h3>
      <p className="text-lg text-center text-[#4C4C4C] px-32 my-3 w-2/3 mx-auto">
